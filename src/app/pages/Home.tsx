    ...
    <div className="pt-20">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden py-12 -mt-20">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(192, 132, 252, 0.4) 0%, rgba(192, 132, 252, 0.2) 25%, rgba(192, 132, 252, 0.05) 50%, transparent 70%)",
            filter: "blur(80px)",
          }}
        ></div>
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(167, 139, 250, 1) 0%, rgba(167, 139, 250, 0.5) 30%, transparent 70%)",
            filter: "blur(120px)",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(192, 132, 252, 1) 0%, rgba(192, 132, 252, 0.6) 30%, transparent 70%)",
            filter: "blur(120px)",
            transform: "translate(30%, 30%)",
          }}
        ></div>
        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8 w-full relative z-10">
          ...
          <motion.div
            ...
            style={{
              boxShadow:
                "0 0 60px rgba(167, 139, 250, 0.3), 0 20px 40px rgba(0, 0, 0, 0.4)",
            }}
          >
        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-bold">
              <span className="text-primary/60 font-mono text-base mr-3">
                &lt;AboutMe /&gt;
              </span>
              About Me
            </h2>
          ...
          >
            ...
            <div className="w-full md:w-[60%]">
              {/* Text Paragraphs */}
              <div
                className="space-y-5 text-slate-300 mb-8"
              ...
              >
                ...
                <p>
                  ...
                  Whether it's front-end development, back-end architecture, or
                  UI/UX design, I bring a holistic approach to every project.
                </p>
              </div>
              ...
              <motion.div
                ...
                style={{
                  boxShadow:
                    "inset 0 0 30px rgba(167, 139, 250, 0.1), 0 0 20px rgba(167, 139, 250, 0.15)",
                }}
              >
