...
import { User, Code, Mail, Github, Linkedin, Monitor, Edit, Plus, Trash2, GraduationCap, Award, MapPin, Calendar } from 'lucide-react';
...
export default function Portfolio() {
    ...
    const skills = [
        { category: "Frontend", items: ["React", "Vue.js", "TypeScript", "Tailwind CSS", "JavaScript"] },
        { category: "Backend", items: ["Java", "Spring Boot", "Node.js", "Python", "REST APIs"] },
        { category: "Database", items: ["PostgreSQL", "MongoDB", "MySQL", "Redis"] },
        { category: "Tools", items: ["Git", "Docker", "AWS", "Jenkins", "IntelliJ IDEA"] }
    ];
    ...
    const HomePage = () => (
        <div className="min-h-screen pt-20 flex items-center bg-gray-900 relative overflow-hidden">
            ...
            <div className="absolute inset-0">
                ...
                <div className="absolute top-40 right-10 w-72 h-72 bg-purple-600 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-pulse" style={{animationDelay: '2s'}}></div>
                <div className="absolute -bottom-8 left-20 w-72 h-72 bg-cyan-600 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-pulse" style={{animationDelay: '4s'}}></div>
            </div>

            <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
                <div className="space-y-8">
                    {/* Greeting with typing effect simulation */}
                    <div className="space-y-4">
                        <div className="text-lg text-blue-400 font-medium">👋 Hello there! I'm</div>
                        <h1 className="text-5xl md:text-6xl font-bold text-white leading-tight">
                            <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Samir</span>
                            <br />
                            <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Mahmoud</span>
                        </h1>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative bg-gray-900 border border-gray-700 rounded-lg px-6 py-4">
                            <p className="text-xl text-gray-300 leading-relaxed">
                                ...
                                <span className="text-purple-400 font-semibold"> Web Developer</span> pursuing my
                                Master's in Computer Science. I build modern web applications with clean code and user-focused design.
                            </p>
                        </div>
                    </div>
              ...
              <span className="flex items-center justify-center">
                    ...
                    <div className="flex items-center space-x-6 pt-4">
                        ...
                        <div className="flex space-x-4">
                            <div className="group relative">
                                ...
                                <Github className="relative w-6 h-6 text-gray-400 group-hover:text-white cursor-pointer transition-all duration-300 group-hover:scale-110" />
                            </div>
                            <div className="group relative">
                                ...
                                <Linkedin className="relative w-6 h-6 text-gray-400 group-hover:text-blue-400 cursor-pointer transition-all duration-300 group-hover:scale-110" />
                            </div>
                            <div className="group relative">
                                ...
                                <Mail className="relative w-6 h-6 text-gray-400 group-hover:text-red-400 cursor-pointer transition-all duration-300 group-hover:scale-110" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative flex items-center justify-center">
                    ...
                    <div className="absolute inset-0">
                        ...
                        <div className="absolute inset-8 w-80 h-80 border-2 border-purple-500/20 rounded-full animate-spin" style={{animationDuration: '15s', animationDirection: 'reverse'}}></div>
                ...
                <div className="grid md:grid-cols-2 gap-12 mb-16">
                    <div>
                        ...
                        <p className="text-gray-300 leading-relaxed mb-6">
                            ...
                            with a solid foundation from my Bachelor's in Computer Information Systems.
                        </p>
                        <p className="text-gray-300 leading-relaxed">
                            My goal is to create efficient, scalable, and user-friendly applications that solve
                            real-world problems.
                        </p>
                    </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {projects.map((project) => (
                      ...
                      {tech}
                                ...
                                <div className="flex space-x-4">
                                    <a href={project.github} className="text-blue-400 hover:text-blue-300 text-sm">
                                        <Github className="w-4 h-4 inline mr-1" />
                                        Code
                                    </a>
                                    <a href={project.live} className="text-blue-400 hover:text-blue-300 text-sm">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    <div>
                        <div className="space-y-6">
                            ...
                            <button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg transition-colors font-medium cursor-pointer">
                                Send Message
                            </button>
                        </div>
                    </div>
            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                {!isAdmin && (
                    <div className="bg-gray-800 p-6 rounded-lg mb-8">
                        <h3 className="text-white font-semibold mb-4">Admin Access Required</h3>
